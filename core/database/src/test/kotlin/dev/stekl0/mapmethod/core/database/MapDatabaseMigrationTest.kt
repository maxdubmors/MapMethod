...
class MapDatabaseMigrationTest {
    ...
    @Test
    fun `reseed stamps the first cells with the old timestamps in order`() {
    ...
    @Test
    fun `reseed with no fills leaves the new mask unfilled`() {
    ...
    @Test
    fun `reseed clamps when old fills exceed the new total`() {
        val reseeded =
